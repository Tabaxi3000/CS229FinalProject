...
def train_mcts(num_episodes=5000, lr=0.0001, num_simulations=50, c_puct=1.0, 
    ...
    for episode in pbar:
        ...
        if (episode + 1) % eval_interval == 0:
            win_rate = evaluate_agent(policy_value_net, env, device, num_games=20, num_simulations=num_simulations)[0]
            ...
            pbar.set_postfix({
                ...
                'p_loss': f'{policy_losses[-1]:.4f}',
                'v_loss': f'{value_losses[-1]:.4f}'
            })
...
if __name__ == "__main__":
    ...
    parser.add_argument('--c-puct', type=float, default=1.0, help='PUCT constant')
